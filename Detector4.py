    ...
    def main_app10():
        ...
        if keep_processing:
            ...
            for encodeFace, faceLoc in zip(encodesCurFrame, facesCurFrame):
                ...
                if matches[matchIndex]and (faceDis[matchIndex]>0.30):
                                ...
                                if j[0] == name2:
                                    ...
                                    if a:
                                            ...
                                            if Matricule is None:
                                                messagebox.showerror("ERROR", "We can't find a matricule for '{}'".format(Namematricule))
                                            else:
                                                ...
                                                with open("host.csv", "r+") as f:
                                                    ...
                                                    f.writelines(f'{Namematricule},{Matricule},{name},Face Recognition,{dtString} \n')
